...
if clean_cond == 1
    para.output = sprintf('nnet/DNN_phone_clean_AU4');
else
    para.output = sprintf('nnet/DNN_phone_multi_AU4');
end
...
% you should be able to get about 48% phone accuracy using clean condition
% training. 
